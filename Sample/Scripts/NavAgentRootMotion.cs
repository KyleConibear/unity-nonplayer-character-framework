...
public class NavAgentRootMotion : MonoBehaviour 
{
	...
	public Conibear.AIWaypointNetwork WaypointNetwork = null;
	...
	void SetNextDestination ( bool increment )
	{
		...
		int nextWaypoint = (CurrentIndex+incStep>=WaypointNetwork.WaypointsTransform.Length)?0:CurrentIndex+incStep;
		nextWaypointTransform = WaypointNetwork.WaypointsTransform[nextWaypoint];
